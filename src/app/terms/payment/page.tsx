      ...
      <main className="max-w-3xl mx-auto px-6 py-12" dir="rtl">
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            שירות עיבוד התשלומים מסופק על-ידי <strong>SUMIT</strong>, גוף סולק מורשה לפי חוק שירותי תשלום, תשע"ט-2019, ובכפוף לתקן{' '}
        ...
        <section className="mb-10">
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-700 leading-relaxed">
            <li>לאחר אישור ההזמנה, הצד המשלם מזין את פרטי כרטיס האשראי בדף תשלום מאובטח (HTTPS / PCI DSS).</li>
            <li>התשלום מבוצע בכרטיס אשראי דרך SUMIT Marketplace.</li>
            <li>עם השלמת התשלום, הפלטפורמה מקבלת אישור אוטומטי מ-SUMIT, ההזמנה מאושרת ונשלחת הודעה לשני הצדדים.</li>
            <li>התמורה לספק/ת (אחרי ניכוי עמלת הפלטפורמה) מועברת לחשבון הבנק הרשום, במועדי הסליקה של SUMIT (בדרך כלל 3 ימי עסקים).</li>
          </ol>
        </section>
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-700 leading-relaxed">
            ...
            <li>הפלטפורמה פועלת בהתאם לתקן PCI DSS Level 1 דרך SUMIT.</li>
            <li>WELLNESS&SEA אינה אחראית לפעילות חברת הסליקה SUMIT, לאי-אספקת שירות, או לכל נזק שנגרם כתוצאה מתקלה בחברת כרטיסי האשראי.</li>
          </ul>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed mb-3">
            ספקים (מאמנים/ות ובעלי מקומות) המעוניינים לקבל תשלומים דרך הפלטפורמה נדרשים להשלים תהליך <strong>אימות זהות (KYC)</strong> לפי דרישות חוק שירותי תשלום ורגולציית SUMIT:
          </p>
          <ul className="list-disc list-inside space-y-2 text-gray-700 leading-relaxed">
